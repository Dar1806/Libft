...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/11/11 15:41:33 by nmeunier          #+#    #+#              #
#    Updated: 2025/11/19 09:12:21 by nmeunier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	=	ft_isalnum.c ft_isprint.c ft_memcmp.c \
		...
		ft_strtrim.c  ft_memmove.c ft_strdup.c  ft_strlen.c \
		ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putendl_fd.c \
		ft_memset.c ft_strjoin.c  ft_strtrim.c ft_split.c ft_itoa.c \
